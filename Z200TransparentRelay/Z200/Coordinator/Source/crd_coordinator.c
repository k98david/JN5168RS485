...
extern uint8 u8CmdData;
extern uint8 au8CmdData[117];
/****************************************************************************/
/***        Exported Functions                                            ***/
/****************************************************************************/
...
PRIVATE void CRD_vInit(void)
{
	...
	//NODE_sData.u16PanId = 0xbeef;
	//gConfigData.settings.targetAddr=0xEAE5;
...
PRIVATE void CRD_vIndAssociate(MAC_MlmeDcfmInd_s *psMlmeInd)
{
    uint16 u16ShortAddr = 0xffff,U16Temp=0;
...
*/
	...
	if (gConfigData.settings.verbose){
		...
		//au8CmdData[6]=0;  //for AddRep Data to master
